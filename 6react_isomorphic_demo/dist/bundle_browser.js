...
// 把根组件渲染到 DOM 树上
var _window = window,
    initalData = _window.initalData;

console.log('window initalData', initalData);
(0, _reactDom.render)(_react2.default.createElement(_components2.default, initalData), window.document.getElementById('app'));
...
var AppComponent = function (_Component) {
  ...
  _createClass(AppComponent, [{
    ...
    value: function render() {
      ...
      var ShowComponent = function ShowComponent(path) {
        console.log('path', path);

        if (path === '/') {
          return _react2.default.createElement(_main2.default, _this2.props);
        } else if (path === '/test') {
